...
@section('title', 'Conoce el Modelo 1130 Junta de expansión | BSH')
@section('description', 'Selecciona y cotiza todo el rango de materiales y dimensiones modelo 1130 Junta de Expansión, 
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Junta de expansión Modelo 1130",
  "description": "La Junta de expansión Modelo 1130 está diseñada para soportar un rango mayor de movimientos laterales gracias a su mayor longitud y número de corrugaciones entre brida y brida. Disponible en configuraciones de arco estándar, fluido y arco relleno, esta junta ofrece estabilidad adicional para movimientos laterales de hasta 4\". Se fabrica en diversos hules de alta calidad, incluyendo HULE NATURAL, EPDM, Neopreno, Clorobutilo, Nitrilo, Hypalon®, Viton® y Teflon®, tanto en versión estándar como de grado alimenticio.",
  "sku": "1130-BSH",
  "mpn": "1130-2024",
  "brand": {
    "@type": "Brand",
  ...
  "image": [
    "https://juntasflexibles.com/img/procesadas/1130-mosaico-ok-small.webp",
    "https://juntasflexibles.com/img/procesadas/1130-mosaico-ok-medium.webp",
    "https://juntasflexibles.com/img/procesadas/1130-mosaico-ok-large.webp"
  ],
  "offers": {
    "@type": "Offer",
    "url": "https://juntasflexibles.com/producto/juntas-de-expansion-1130",
    "priceCurrency": "MXN",
  ...
  <div class="max-w-screen-xl mx-auto px-4">
      <main>
          <div class="text-center my-5">
              <h2 class="text-2xl font-bold text-primaryBlue">Modelo Seleccionado: Junta de expansión Estilo <span id="parrafo_modelo">1130</span></h2>
          </div>
            ...
            <section class="text-center">
              <picture>
                ...
                <source 
                    type="image/webp" 
                    srcset="
                        {{ asset('img/procesadas/1130-mosaico-ok-small.webp') }} 480w,
                        {{ asset('img/procesadas/1130-mosaico-ok-medium.webp') }} 800w,
                        {{ asset('img/procesadas/1130-mosaico-ok-large.webp') }} 1200w"
                ...
                <source 
                    type="image/jpeg" 
                    srcset="
                        {{ asset('img/procesadas/1130-mosaico-ok-small.jpg') }} 480w,
                        {{ asset('img/procesadas/1130-mosaico-ok-medium.jpg') }} 800w,
                        {{ asset('img/procesadas/1130-mosaico-ok-large.jpg') }} 1200w"
                    sizes="(max-width: 480px) 480px, (max-width: 800px) 800px, 1200px">
                
                <!-- Etiqueta img como último recurso -->
                <img 
                  id="imagen_destacada_img"
                    src="{{ asset('img/procesadas/1130-mosaico-ok-large.jpg') }}" 
              ...
              <section class="text-justify">
                  <p id="descripcion_parrafo" class="mb-4 text-[13px]">
                    Junta 1130 Diseñada para soportar un rango mayor de movimientos laterales debido a la longitud y el número de corrugaciones que hay entre brida y brida. Es un diseño de triple arco bajo especificación para proporcionar estabilidad adicional para los movimientos laterales de hasta 4". Las juntas de expansión 1130 disponibles en arco estándar, fluido y arco relleno. Las Juntas de Expansión 1130 se fabrican en diferentes hules y combinaciones HULE NATURAL, EPDM, Neopreno, 
                    Clorobutilo, Nitrilo, Hypalon®, Viton®, Teflon®, estos en negro y en grado alimenticio. </p>
                  <picture>
                    <!-- Fuente para navegadores que soportan WebP -->
                    <source 
                        type="image/webp" 
                    ...
                    <img 
                        ...
                        alt="Imagen diagrama Junta de expansión 1130" 
              ...
              <section>
                <picture>
                  ...
                  <source 
                      type="image/webp" 
                      srcset="
                          {{ asset('img/procesadas/Modelo-05-small.webp') }} 480w,
                          {{ asset('img/procesadas/Modelo-05-medium.webp') }} 800w,
                          {{ asset('img/procesadas/Modelo-05-large.webp') }} 1200w"
                      sizes="(max-width: 480px) 480px, (max-width: 800px) 800px, 1200px">
                  ...
                  <source 
                      type="image/jpeg" 
                      srcset="
                          {{ asset('img/procesadas/Modelo-05-small.jpg') }} 480w,
                          {{ asset('img/procesadas/Modelo-05-medium.jpg') }} 800w,
                          {{ asset('img/procesadas/Modelo-05-large.jpg') }} 1200w"
                      sizes="(max-width: 480px) 480px, (max-width: 800px) 800px, 1200px">
                  
                  <!-- Etiqueta img como último recurso -->
                  <img 
                    id="imagen_2d_img"
                      src="{{ asset('img/procesadas/Modelo-05-large.jpg') }}" 
                      alt="Imagen arco junta expansión 1130" 
                      class="mx-auto w-[300px] transition-transform duration-300 ease-in-out hover:scale-110"
                      loading="lazy">
              </picture>
            </section>
          ...
          <section class="my-8">
              <h2 class="text-xl font-semibold text-primaryBlue text-center mb-4">
                  Movimientos de la Junta de expansión modelo: 1130
              </h2>
    ...
    <thead>
      <tr class="bg-primaryBlue text-white">
        ...
        <th class="border border-[#dddddd] p-2 text-left font-bold">EXTENSIÓN in</th>
    ...
    <div id="seleccion-resultado" class="bg-gray-100 p-4 rounded shadow-md md:flex">
      <h3 class="text-lg font-bold md:w-1/2">Modelo: 1130</h3>
